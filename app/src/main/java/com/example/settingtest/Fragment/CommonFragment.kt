...
class CommonFragment : Fragment() {
    ...
    private val onClickListener = View.OnClickListener {
        when (it) {
            binding.labelAboutMachine.layoutRoot -> {
    ...
    private fun initView() {
        binding.labelAboutMachine.txtTitle.text = "关于本机"
        binding.labelAboutMachine.txtDescription.visibility = View.GONE
        binding.labelAboutMachine.layoutRoot.setOnClickListener(onClickListener)
        ...
        binding.labelEnergy.imgGoTo.visibility = View.VISIBLE
